...
export class AuthService {
  ...
  // Google OAuth
  async googleAuth(oauthUser: OAuthUser) {
    const { name, email, refreshToken } = oauthUser;
    // Find user
  ...
  async facebookAuth(oauthUser: facebookOAuthUser) {
  ...
  // Facebook OAuth
  // async facebookAuth(oauthDto: OAuthDto) {
  //   const { name, email, oauthId } = oauthDto;
  ...
  //   if (user) {
  //     // If user exists but no oauthId, update
  //     if (!user.oauthId) {
  ...
  //   } else {
  //     // Create new user
  //     // For OAuth users, we still need to set a password, but it will never be used
